/**
 * 提示词模板（自 modules/prompt/performer_prompt_en.py 机械移植）。
 *
...
export const ROLE_NPC_RESPONSE_PROMPT = `
...
export const ROLE_SINGLE_ROLE_RESPONSE_PROMPT = `
...
export const ROLE_MULTI_ROLE_RESPONSE_PROMPT = ` 
You are {role_name}. Your nickname is {nickname}. 
...
export const UPDATE_STATUS_PROMPT = `
You are {role_name}.
...
export const ROLE_SET_MOTIVATION_PROMPT = ` 
You are {role_name}.
...
export const ROLE_THINK_PROMPT = `
...
export const ROLE_SET_GOAL_PROMPT = `
You are {role_name}.
